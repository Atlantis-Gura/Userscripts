...
function style(){
  GM_addStyle(`
    ...
    #github1sProjectButton .btn-sm {
      padding-left: 4px;  /* 恢复默认左内边距 */
      padding-right: 4px; /* 恢复默认右内边距 */
    }
    #github1sProjectButton .btn-sm svg {
      vertical-align: text-bottom;
      margin-left: 4px;  /* 添加左边距使图标向右移动 */
    }
  `);
}
